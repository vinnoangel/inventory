    ...
    <div class="">
        ...
        <div class="row">
			...
			<?php
						...
						$select_content=("select * from ordertable where xdate = '$xdate' order by xdate desc");
			...
			?>
								<tr height="23" onMouseOver="this.style.backgroundColor='#FFCC66';" onMouseOut="this.style.backgroundColor='';" bgcolor="#EFEFEF">
									<td colspan="5"  align="center">No Order Yet</td>
								</tr>	
			<?php
			}
				else
			...
			<?php 
						$select_content51=("select DISTINCT user from paymenthistory where xdate = '$xdate' and transtype='2' order by pid asc");
						...
						do{
							$user = $content51['user'];
							$select_content5=("select * from paymenthistory where xdate = '$xdate' and user='$user' and transtype='2' order by xdate desc");
